...
1.  **[mema-core](https://github.com/eugen252009/mema-core):** The "Kitchen" (this repo). This is the engine module providing installation primitives (`mema_install`, `mema_link`), caching, and deterministic symlinking.
2.  **[mema-recipes](https://github.com/eugen252009/mema-recipes):** The "Buffet". A collection of shell-based recipes defining how binaries are fetched, verified, and linked.
